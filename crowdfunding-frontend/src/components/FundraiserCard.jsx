...
function FundraiserCard({ fundraiserData }) {
    ...
    const isOpen = Boolean(fundraiserData.is_open);
    ...
    description.length > 110 ? `${description.slice(0, 110)}…` : description || "No description provided.";

    return (
    <Link to={link} className="fc" aria-label={`Open fundraiser: ${title}`}>
        <div className="fc__media">
        <img className="fc__img" src={fundraiserData.image} alt={title} loading="lazy" />
        ...
        <div className="fc__body">
            ...
            <div className="fc__right">
                <div className="fc__line">
                    ...
                    <span className="fc__value">${goal.toLocaleString("en-AU")}</span>
                </div>
            </div>
            </div>
        ...
        <div className="fc__mid">
            <div className="fc__line">
                ...
                <span className="fc__value fc__value--normal">{owner}</span>
            </div>
        ...
        <div className="fc__raisedRow" aria-label="Raised so far">
            <span className="fc__raisedText">
                Raised: <strong>${raised.toLocaleString("en-AU")}</strong>
            </span>

            <span className="fc__goalText">
                Goal: <strong>${goal.toLocaleString("en-AU")}</strong>
            </span>
        </div>
        </div>
    </Link>
