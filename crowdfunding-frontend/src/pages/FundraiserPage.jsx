    ...
    const totalPledged = useMemo(() => {
        ...
        return fundraiser.pledges.reduce(
    ...
    const progressPct =
        goalAmount > 0
        ? Math.min(100, Math.round((totalPledged / goalAmount) * 100))
        : 0;
    ...
    async function handleMakePledge(e) {
        ...
        if (!response.ok) {
            ...
            const msg =
            data?.detail || JSON.stringify(data) || "Failed to make pledge.";
            throw new Error(msg);
        }
    ...
    if (error) {
        return <main className="container section">{String(error)}</main>;
    }
    ...
    return (
        ...
        <header className="fundraiser__header">
            ...
            <span
                ...
                isOpen ? "statusPill--open" : "statusPill--closed"
                }`}
            >
                {statusText}
            </span>
        ...
        <div className="fundraiser__grid">
            ...
            <div className="fundraiser__body">
                ...
                <div className="stat">
                    ...
                    ${totalPledged.toLocaleString("en-AU")}
                    </div>
                </div>
                ...
                <div className="stat">
                    ...
                    <div className="stat__value">
                    ${goalAmount.toLocaleString("en-AU")}
                    </div>
                </div>
                ...
                <h2 className="fundraiser__sectionTitle">
            ...
            <section className="card pledgesCard">
                ...
                <ul className="pledgeList">
                    ...
                    <li key={p.id ?? index} className="pledgeItem">
                        ...
                        {p.comment && (
                        <div className="pledgeItem__comment">{p.comment}</div>
                        )}
                    </li>
                    ))}
                </ul>
